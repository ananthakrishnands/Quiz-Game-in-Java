    ...
    System.out.println("connected to db");
        ...
        System.out.println("error in connection");
           ...
           if(rs.next()){
               ...
               SharedData.setqnid(rs.getInt("QN_ATTEMPTED"));
               System.out.println("QN="+rs.getString("QN_ATTEMPTED"));
               ...
               query="insert into users values('"+username+"','"+pwd+"',0,0,0)";
               rs=st.executeQuery(query);
               SharedData.setname(username);
               SharedData.setscore(0);
               SharedData.setqnid(1);
           ...
           jLabel6.setText("Player already exists!");
       }
